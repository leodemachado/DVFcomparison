 ...
 *
 *=========================================================================*/
#ifndef itkMachadoMutualInformationImageToImageMetricv4_h
#define itkMachadoMutualInformationImageToImageMetricv4_h

#include "itkImageToImageMetricv4.h"
#include "itkMachadoMutualInformationImageToImageMetricv4GetValueAndDerivativeThreader.h"
#include "itkPoint.h"
#include "itkIndex.h"
...
/** \class MachadoMutualInformationImageToImageMetricv4
 *
 * \brief Computes the mutual information between two images to be
 * registered using the method of Machado et al.
 *
 * MachadoMutualInformationImageToImageMetric computes the mutual
 ...
 * Machado MI metric, i.e. itkMachadoMutualInformationImageToImageMetric.
 *
 * See
 *  MachadoMutualInformationImageToImageMetricv4GetValueAndDerivativeThreader::ProcessPoint
...
class ITK_TEMPLATE_EXPORT MachadoMutualInformationImageToImageMetricv4
  : public ImageToImageMetricv4<TFixedImage, TMovingImage, TVirtualImage, TInternalComputationValueType, TMetricTraits>
{
public:
  ITK_DISALLOW_COPY_AND_ASSIGN(MachadoMutualInformationImageToImageMetricv4);

  /** Standard class type aliases. */
  using Self = MachadoMutualInformationImageToImageMetricv4;
  using Superclass =
  ...
  itkTypeMacro(MachadoMutualInformationImageToImageMetricv4, ImageToImageMetricv4);
...
protected:
  MachadoMutualInformationImageToImageMetricv4();
  ~MachadoMutualInformationImageToImageMetricv4() override = default;

  friend class MachadoMutualInformationImageToImageMetricv4GetValueAndDerivativeThreader<
  ...
  friend class MachadoMutualInformationImageToImageMetricv4GetValueAndDerivativeThreader<
    ...
    Superclass,
    Self>;
  using MachadoMutualInformationDenseGetValueAndDerivativeThreaderType =
    MachadoMutualInformationImageToImageMetricv4GetValueAndDerivativeThreader<
      ThreadedImageRegionPartitioner<Superclass::VirtualImageDimension>,
      Superclass,
      Self>;
  using MachadoMutualInformationSparseGetValueAndDerivativeThreaderType =
    MachadoMutualInformationImageToImageMetricv4GetValueAndDerivativeThreader<ThreadedIndexedContainerPartitioner,
                                                                             Superclass,
                                                                             Self>;
...
#  include "itkMachadoMutualInformationImageToImageMetricv4.hxx"
#endif
