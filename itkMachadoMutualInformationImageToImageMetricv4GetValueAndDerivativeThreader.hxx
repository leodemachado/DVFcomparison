 ...
 *
 *=========================================================================*/
#ifndef itkMachadoMutualInformationImageToImageMetricv4GetValueAndDerivativeThreader_hxx
#define itkMachadoMutualInformationImageToImageMetricv4GetValueAndDerivativeThreader_hxx
...
MachadoMutualInformationImageToImageMetricv4GetValueAndDerivativeThreader<
  TDomainPartitioner,
  TImageToImageMetric,
  TMachadoMutualInformationMetric>::BeforeThreadedExecution()
{
  ...
  this->m_MachadoAssociate = dynamic_cast<TMachadoMutualInformationMetric *>(this->m_Associate);
...
MachadoMutualInformationImageToImageMetricv4GetValueAndDerivativeThreader<
  TDomainPartitioner,
  TImageToImageMetric,
  TMachadoMutualInformationMetric>::ProcessPoint(const VirtualIndexType & virtualIndex,
...
template <typename TDomainPartitioner, typename TImageToImageMetric, typename TMachadoMutualInformationMetric>
void
MachadoMutualInformationImageToImageMetricv4GetValueAndDerivativeThreader<TDomainPartitioner,
                                                                         TImageToImageMetric,
                                                                         TMachadoMutualInformationMetric>::
...
MachadoMutualInformationImageToImageMetricv4GetValueAndDerivativeThreader<
  TDomainPartitioner,
  TImageToImageMetric,
  TMachadoMutualInformationMetric>::AfterThreadedExecution()
{
  const ThreadIdType localNumberOfWorkUnitsUsed = this->GetNumberOfWorkUnitsUsed();
   ...
   * MachadoMutualInformationImageToImageMetric::GetValueAndDerivativeThreadPostProcess */
